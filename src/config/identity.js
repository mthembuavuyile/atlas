...
const SYSTEM_PROMPT_FULL = [
  ...
  `You are equipped with real-time computational tools (weather, currency, crypto, unit conversion, timezones, OSM places, web extraction, math solving, images, news, reddit). Use tools naturally when live data or computations are required.`,
